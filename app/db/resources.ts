...
export const resources: Array<Resources> = [
  {
    ...
    colour: '#78350f',
    colourClass:
      'bg-gradient-to-l from-yellow-900 via-yellow-900 to-yellow-900 text-white',
    id: 1,
    description:
...

  {
    ...
    colour: '#e0e0e0',
    colourClass:
      'bg-gradient-to-r from-neutral-700 via-stone-700 to-stone-700 text-white',
    id: 2,
    description:
  ...
  },
  {
    ...
    colour: '#fcd34d',
    colourClass:
      'bg-gradient-to-r from-yellow-200 to-yellow-500 text-yellow-800',
    id: 9,
    description:
  ...
  },
  {
    ...
    colour: '#ccbcfb',
    colourClass:
      'bg-gradient-to-tl from-transparent via-gray-200 to-gray-100 text-black',
    id: 11,
    description:
  ...
  },
  {
    ...
    colour: '#3b82f6',
    colourClass:
      'bg-gradient-to-tl from-blue-200 via-blue-700 to-blue-800 text-white',
    id: 12,
    description:
  ...
  },
  {
    ...
    colour: '#ef4444',
    colourClass:
      'bg-radial-at-t from-red-600 via-black to-red-700 text-red-200',
    id: 15,
    description:
  ...
  },
  {
    ...
    colour: '#bdbdbd',
    colourClass:
      'bg-radial-at-t from-blue-50 via-cyan-500 to-cyan-100 shimmer text-white fast',
    id: 19,
    description:
  ...
  },
  {
    ...
    colour: '#1e3a8a',
    colourClass:
      'bg-conic-to-t from-emerald-700 via-yellow-500 to-emerald-900 shimmer slow',
    id: 20,
    description:
  ...
  },
  {
    ...
    colour: '#60a5fa',
    colourClass:
      'bg-radial-at-r from-blue-400 via-blue-100 to-teal-500 shimmer text-blue-800 fast',
    id: 21,
    description:
  ...
  },
  {
    ...
    colour: '#ec4899',
    colourClass:
      'bg-gradient-to-tl from-rose-500 via-violet-900 to-rose-800 shimmer fast',
    id: 22,
    description:
